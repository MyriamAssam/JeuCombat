...
public class MaquetteJoueurs {
	...
	public static Joueur creerJoueur(String id, String prenom, String nom) {
	...
	private static String prenomAleatoire() {
		...
		List<String> choixDeNoms = List.of("Alice", "Bob", "Chaaya", "Dominic", "Élisabeth", "Firas", "Gregson",
				"Mehdi", "Louis", "Marcel", "Ashwin", "Ichiro", "Jun");
	...
	private static String nomAleatoire() {
		...
		List<String> choixDeNoms = List.of("Abdenouri", "Ahmadi", "Augustin", "Chaussé", "Delisle", "Heer", "Lagrois",
				"Daverna", "Gonzales", "Medjoubi", "Castillo", "Josan", "Yi");
